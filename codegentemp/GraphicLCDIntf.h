...
#define GraphicLCDIntf_BUS_WIDTH (16u)
...
#define CYGRAPHICS_WRITE(addr, data)        GraphicLCDIntf_Write16(addr, data)
#define CYGRAPHICS_READ(addr)               GraphicLCDIntf_Read16(addr)
#define CYGRAPHICS_WRITEM(addr, data, num)  GraphicLCDIntf_WriteM16(addr, data, num)
#define CYGRAPHICS_READM(addr, data, num)   GraphicLCDIntf_ReadM16(addr, data, num)
...
#define GraphicLCDIntf_READ_HIGH_PULSE          (3u - 1u)
